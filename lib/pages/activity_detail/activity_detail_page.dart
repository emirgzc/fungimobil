...
class _ActivityDetailPageState extends State<ActivityDetailPage>
      ...
      children: [
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: () => widget.data['room_status'].toString() == "0"
                ? recordPop(context)
                : recordPopWithRoom(context),
            child: Container(
              height: 64,
              width: sizeWidht,
  ...
  Future recordPopWithRoom(BuildContext context) {
    return showModalBottomSheet(
      isScrollControlled: true,
      context: context,
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    for (int i = 0; i < 5; i++) roomCard(),
                  ],
                ),
              ),
              const SizedBox(height: 32),
              const Text(
                  "Etkinliğimize konaklamasız kaç kişi katılmak istiyorsunuz?"),
              CustomTextField(hintText: "Kişi Sayısı"),
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8.h),
          const Text("Oda Numarası"),
          SizedBox(height: 8.h),
          const Text("3000 ₺"),
          SizedBox(height: 8.h),
          const Text("3 Kişilik"),
          SizedBox(height: 8.h),
          const Text("Oda açıklaması"),
          CustomTextField(hintText: "Kişi Sayısı"),
        ],
      ),
    );
